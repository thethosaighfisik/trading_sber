...
# # =====================================================
# # 1. ОЦЕНКА HEDGE RATIO (KALMAN FILTER)
# # =====================================================
...
#     # update
#     K = P * x / (x * P * x + R)
#     beta = beta_pred + K * (y - beta_pred * x)
#     P = (1 - K * x) * P
...
# # =====================================================
# # 2. СПРЕД С УЧЁТОМ ДИНАМИЧЕСКОГО ХЕДЖА
# # =====================================================

# df["spread"] = df["mid_future"] - df["mid_spot"]

# df = df.dropna().reset_index(drop=True)

# # =====================================================
# # 3. ФИЛЬТР РЕЖИМА (VOLATILITY REGIME FILTER)
# # =====================================================

# df["vol"] = df["spread"].rolling(WINDOW_VOL).std()

# # df["trade_allowed"] = df["vol"] > df["vol"].median()
...
# # =====================================================
# # 5. СОСТОЯНИЕ СТРАТЕГИИ (POSITIONS, PNL)
# # =====================================================

# pos_f = 0
# pos_s = 0
# pos_dir = 0   # +1 long spread, -1 short spread
...
# # =====================================================
# # 6. БЭКТЕСТ СТРАТЕГИИ (MAIN TRADING LOOP)
# # =====================================================
# # Mean-reversion strategy:
# # enter when spread deviates from zero
# # exit when it reverts back

# # thresholds based on spread volatility (heuristic)
# THRESHOLD = df["spread"].std() * 0.8
# EXIT_THRESHOLD = df["spread"].std() * 0.2
# TC_BUFFER = 0.01
...
#         if spread > THRESHOLD + TC_BUFFER:

#             pos_f = -LOT
#             pos_s = +LOT * row["beta"]
#             pos_dir = -1

#             entry_f = exec_price(row["mid_future"], "sell" if pos_f < 0 else "buy")
#             entry_s = exec_price(row["mid_spot"], "buy" if pos_s > 0 else "sell")

#         elif spread < -THRESHOLD - TC_BUFFER:
...
#     elif pos_dir != 0 and abs(spread) < EXIT_THRESHOLD:
...
# # =====================================================
# # 7. РЕЗУЛЬТАТЫ БЭКТЕСТА
# # =====================================================

# print("="*60)
# print("HEDGE FUND BASIS STRATEGY RESULTS")
# print("="*60)
...
# =====================================================
# STRATEGY: IMPROVED BASIS MEAN REVERSION
# =====================================================
